...
- I'm currently learning to code using .NET 
- My goals are to build software with minimal assistance from tutorials and the like
...
<!--
**NtombiHontyo/NtombiHontyo** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
